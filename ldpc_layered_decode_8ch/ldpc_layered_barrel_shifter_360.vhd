...
--
-- Latency: 3 clocks from i_valid/iv_data/iv_shift to o_valid/ov_data.
----------------------------------------------------------------------------------

library IEEE;
use IEEE.STD_LOGIC_1164.ALL;

entity ldpc_layered_barrel_shifter_360 is
    Port (
        i_clk    : in  STD_LOGIC;
        i_rst    : in  STD_LOGIC;
...
end ldpc_layered_barrel_shifter_360;

architecture Behavioral of ldpc_layered_barrel_shifter_360 is

    signal valid_d1, valid_d2, valid_d3 : STD_LOGIC := '0';
    signal sh87_d1                      : STD_LOGIC_VECTOR(1 downto 0) := (others => '0');
    signal sh64_d1, sh64_d2             : STD_LOGIC_VECTOR(2 downto 0) := (others => '0');
    signal sh30_d1, sh30_d2, sh30_d3    : STD_LOGIC_VECTOR(3 downto 0) := (others => '0');
